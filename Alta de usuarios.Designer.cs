...
namespace Proyecto_Agraria_Pacifico
{
    partial class Alta_de_usuarios
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Layout base
            int x1 = 28, x2 = 200, y = 72, sepY = 36, w = 300, h = 24;
            ...
            textBoxObservaciones = new TextBox { Location = new Point(x2, y - 3), Size = new Size(w, 80), Multiline = true };
            ...
            // Columna derecha
            int x3 = 560, y2 = 72, w2 = 300;

            labelRol = new Label { AutoSize = true, Location = new Point(x3, y2), Text = "Rol:" };
            comboBoxRol = new ComboBox { DropDownStyle = ComboBoxStyle.DropDownList, Location = new Point(x3 + 140, y2 - 3), Size = new Size(w2 - 140, h) }; y2 += sepY;

            labelEstado = new Label { AutoSize = true, Location = new Point(x3, y2), Text = "Estado:" };
            comboBoxEstado = new ComboBox { DropDownStyle = ComboBoxStyle.DropDownList, Location = new Point(x3 + 140, y2 - 3), Size = new Size(w2 - 140, h) }; y2 += sepY;

            labelArea = new Label { AutoSize = true, Location = new Point(x3, y2), Text = "Área:" };
            comboBoxArea = new ComboBox { DropDownStyle = ComboBoxStyle.DropDownList, Location = new Point(x3 + 140, y2 - 3), Size = new Size(w2 - 140, h) }; y2 += sepY;

            labelPreguntaSeg = new Label { AutoSize = true, Location = new Point(x3, y2), Text = "Pregunta de seguridad:" };
            comboBoxPreguntaSeg = new ComboBox { DropDownStyle = ComboBoxStyle.DropDownList, Location = new Point(x3 + 140, y2 - 3), Size = new Size(w2 - 140, h) }; y2 += sepY;

            labelRespuestaSeg = new Label { AutoSize = true, Location = new Point(x3, y2), Text = "Respuesta de seguridad:" };
            textBoxRespuestaSeg = new TextBox { Location = new Point(x3 + 140, y2 - 3), Size = new Size(w2 - 140, h) }; y2 += sepY;
            ...
            var spacer = new Panel { Location = new Point(0, 540), Size = new Size(10, 10) };
